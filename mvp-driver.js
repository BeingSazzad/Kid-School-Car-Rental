...
(function () {
  ...
  function normalizeRequest(req) {
    ...
    if (/sadia/i.test(req.parentName || '')) req.parentName = 'Sarah Tremblay';
  ...
  function renderRequestDetail() {
    ...
    let parentPhoto = req.parentPhoto || (PARENTS[req.parentId] && PARENTS[req.parentId].photo) || (req.parentId === 'PRNT-5520' ? '/assets/avatar_sarah.jpg' : '/assets/avatar_sadia.jpg');
